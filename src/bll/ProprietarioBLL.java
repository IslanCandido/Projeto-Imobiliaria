...
public class ProprietarioBLL extends ValidacoesPessoasBLL {
    ...
    public boolean salvar(Proprietario proprietario) throws Exception {
        return dal.adicionar(proprietario);
    }

    public boolean editar(Proprietario proprietario) throws Exception {
        return dal.alterar(proprietario);
    }

    public boolean remover(Proprietario proprietario) throws Exception {
        return dal.excluir(proprietario.getCodigo());
    }
